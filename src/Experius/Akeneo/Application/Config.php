 ...
 * functionality from @see \Experius\Akeneo\Application
 *
...
class Config
{
    ...
    /**
     * alias ziggy command in input from config
     *
    ...
    /**
     * Get names of sub-folders to be scanned during Akeneo detection
     *
     * @return array
     */
